...
params:
  output_dir: "gene_signatures_meta_excl_mono"
...
combined_dir <- here(data_dir, "gene_signatures_excl_mono")
...
signature_response_ssgsea_bellini <- read_csv2(
  here(data_dir, "gene_signatures_bellini_excl_mono",
       "signature_response_ssgsea.csv")) %>%
  mutate(Trial = "BELLINI") 
 
signature_response_ssgsea_imcision <- read_csv2(
  here(data_dir, "gene_signatures_imcision_excl_mono",
       "signature_response_ssgsea.csv")) %>%
...
signature_response_ssgsea_matisse <- read_csv2(
  here(data_dir, "gene_signatures_matisse_excl_mono",
       "signature_response_ssgsea.csv")) %>%
...
# Lint script
```{r}
# lint("~/NKI_pancancer_neoadj_io/src/gene_signatures_meta_excl_mono.Rmd")
lint(
  filename = "~/NKI_pancancer_neoadj_io/src/gene_signatures_meta_excl_mono.Rmd",
