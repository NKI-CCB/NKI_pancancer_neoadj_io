...
ssgsea_wes_results_df %>%
  ggplot(aes(x = as.factor(GIE_AP), y = TIL_score, fill = GIE_AP)) +
  geom_boxplot() +
  geom_point(aes(col = GIE_AP)) +
  theme_Publication() +
  guides(col = FALSE)
...
ssgsea_wes_results_df %>%
  mutate(treatment_GIE_AP = paste0(Treatment, GIE_AP)) %>%
  ggplot(aes(x = as.factor(treatment_GIE_AP), y = TIL_score, fill = GIE_AP)) +
  geom_boxplot() +
...
ssgsea_wes_results_df %>%
  ggplot(aes(x = as.factor(GIE_IFNy), y = TIL_score, fill = GIE_IFNy)) +
  geom_boxplot() +
  geom_point(aes(col = GIE_IFNy)) +
  theme_Publication() +
  guides(col = FALSE)
...
```{r}
ssgsea_wes_results_df %>%
  ggplot(aes(x = GIE_AP, y = TIL_score, fill = GIE_AP)) +
  geom_boxplot() +
  geom_point(aes(col = GIE_AP)) +
  theme_Publication() +
  guides(col = FALSE)
...
ssgsea_wes_results_df %>%
  ggplot(aes(x = GIE_AP, y = TIL_score, col = Trial)) +
  geom_boxplot() +
  geom_point() +
  theme_Publication() +
  guides(col = FALSE)
