# RNAseq pipeline
j.traets, version v2.1 (singularity/conda)
updated, June 2023
...
Example:
```bash
python Run_RNApipeline.py /DATA/j.traets/Pipelines/RNAseq_snakemake_pipeline_v2_1/test_data/paired_fastq/ /DATA/j.traets/Pipelines/RNAseq_snakemake_pipeline_v2_draft/output/ -r paired -s yes
```
